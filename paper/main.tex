...
OpenAI ChatGPT (GPT-5.6 Sol) assisted with drafting and editing prose, literature-search organization, and implementation of simulation/plotting code. The authors are responsible for verifying the mathematical derivations, references, code, numerical results, and final manuscript.
